...
import { NCard, NText, NButton, NSkeleton, NFlex, NTag, NIcon, NTable, NTbody } from 'naive-ui'
...
<template>
  <div class="container">
    <NCard class="item-card" :bordered="false">
      ...
      <div
        style="height: 285px; display: flex; align-items: center; justify-content: center"
        v-else
      >
        获取构建信息失败
      </div>
      <NButton
        :disabled="isLoading || !sucessFetch || buildInfo.expired"
        type="primary"
